...
(function (factory) {
  ...
  Viewer.prototype = {
    ...
    build: function () {
     ...
     // getIntroduction('map');
      ...
      if (CurImgs.length == 1 ) {
          ...
          $("#next").css("background-image", "url(UI/right/tool_fd.png)");
          $("#prev").attr("disabled", true);
          $("#prev").css("background-image", "url(UI/right/tool_ed.png)");

      } else if (CurImgs.length != 1 && CurImgsIndex == 0) {
          $("#next").attr("disabled", false);
          $("#next").css("background-image", "url(UI/right/tool_f01.png)");
          $("#prev").attr("disabled", true);
          $("#prev").css("background-image", "url(UI/right/tool_ed.png)");
      }
      else if (CurImgs.length != 1 && CurImgsIndex > 0 && CurImgsIndex < CurImgs.length-1) {
          $("#next").attr("disabled", false);
          $("#next").css("background-image", "url(UI/right/tool_f01.png)");
          $("#prev").attr("disabled", false);
          $("#prev").css("background-image", "url(UI/right/tool_e01.png)");
      }
      else if (CurImgs.length != 1 &&  CurImgsIndex ==CurImgs.length-1) {
          $("#next").attr("disabled", true);
          $("#next").css("background-image", "url(UI/right/tool_fd.png)");
          $("#prev").attr("disabled", false);
          $("#prev").css("background-image", "url(UI/right/tool_e01.png)");
    ...
    prev: function () {
        ...
        } else if ((this.index - 1) < this.length) {
            $("#next").attr("disabled", false);
            $("#next").css("background-image", "url(UI/right/tool_f01.png)");
        }
        if ((this.index-1) == 0) {
    ...
    next: function () {
        ...
        } else if ((this.index + 2) < this.length) {
            $("#next").attr("disabled", false);
            $("#next").css("background-image", "url(UI/right/tool_f01.png)");
        }
        if ((this.index + 1) == 0) {
