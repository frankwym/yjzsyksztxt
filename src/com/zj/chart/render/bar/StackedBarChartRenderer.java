...
public class StackedBarChartRenderer extends BarChartRenderer
     ...
     */
    public StackedBarChartRenderer(boolean renderAsPercentages) {
        super();
...
//        	g2.fill(bar);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StackedBarChartRenderer)) {
            return false;
        }
        StackedBarChartRenderer that = (StackedBarChartRenderer) obj;
