...
public class BarChartRenderer extends BarRenderer
     ...
     * @since 1.0.11
     */
    private static BarPainter defaultBarPainter = new GradientBarPainter(0.2,0.5,0.8);
    
    /**
     * by zf 2009.12.23
     */
    private static BarChartPainter barChartPainter = new GradientBarChartPainter() ;
    ...
    public static BarPainter getDefaultBarPainter() {
        return BarChartRenderer.defaultBarPainter;
    }
    ...
    public static void setDefaultBarPainter(BarPainter painter) {
        ...
        BarChartRenderer.defaultBarPainter = painter;
    }
     ...
     * of values in the dataset, plus the flag that determines w
     * hether or not
...
//        GradientPaint pBarPainter = new GradientPaint((float) barW0,(float) (barL0 + barLength), (Color)itemPaint,(float) (barW0+ state.getBarWidth()/2),(float) (barL0 + barLength ),new Color(255, 255, 255, 255),true);
//
//        g2.setPaint(pBarPainter);
     ...
     * @return A boolean.
     */
    protected boolean isInternalAnchor(ItemLabelAnchor anchor) {
    ...
    public boolean equals(Object obj) {
        ...
        BarChartRenderer that = (BarChartRenderer) obj;
    ...
    public BarChartPainter getTBarPainter() {
		return barChartPainter;
	}
	public void setTBarPainter(BarChartPainter barPainter) {
		barChartPainter = barPainter;
	}
