...
public class BarChart3DRenderer extends BarChartRenderer{
     ...
     */
    public BarChart3DRenderer(double xOffset, double yOffset) {
...
//        g2.draw(corner);
    ...
    public void drawItem(Graphics2D g2,
        ...
        //GradientPaint pBarPainter = new GradientPaint((float) bar.getX(),(float) (bar.getY() - bar.getHeight()/2), new Color(170,0, 0, 200),(float) (bar.getX() + bar.getWidth()),(float) (bar.getY() + bar.getHeight()/2),new Color(170, 170, 0, 200));
        //GradientPaint pBarPainter = new GradientPaint((float) bar.getX(),(float) (bar.getY() - bar.getHeight()/2), (Color)itemPaint,(float) (bar.getX() + bar.getWidth()),(float) (bar.getY() - bar.getHeight()/2),new Color(255, 255, 255, 200),true);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BarChart3DRenderer)) {
            return false;
        }
        BarChart3DRenderer that = (BarChart3DRenderer) obj;
