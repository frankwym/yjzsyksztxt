...
/**
 * An implementation of the {@link BarChartPainter} interface that uses several
 * gradient fills to enrich the appearance of the bars.
 *
 * @since 1.0.11
 */
@SuppressWarnings("serial")
public class GradientBarChartPainter implements BarChartPainter, Serializable {
     ...
     */
    public GradientBarChartPainter() {
        this(0.10, 0.20, 0.80);
    }
     ...
     * @param g3
     */
    public GradientBarChartPainter(double g1, double g2, double g3) {
        this.g1 = g1;
        this.g2 = g2;
        this.g3 = g3;
    }
     ...
     *              bar.
     */
    public void paintBar(Graphics2D g2, BarChartRenderer renderer, int row,
     ...
     */
    public void paintBarShadow(Graphics2D g2, BarChartRenderer renderer, int row,
            int column, RectangularShape bar, RectangleEdge base,
            boolean pegShadow) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GradientBarChartPainter)) {
            return false;
        }
        GradientBarChartPainter that = (GradientBarChartPainter) obj;
        if (this.g1 != that.g1) {
            return false;
        }
        if (this.g2 != that.g2) {
	...
	public void paintBarShadow(Graphics2D g2, BarChartRenderer renderer, 
			int row, int column, Shape s, RectangleEdge base, boolean pegShadow) {
