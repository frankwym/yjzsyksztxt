...
public class TPiePlot extends org.jfree.chart.plot.Plot implements Cloneable, Serializable {

	
	 /** The default insets. */
    public static final RectangleInsets DEFAULT_INSETS
            = new RectangleInsets(-1, 0, 0, 0);
    /** For serialization. */
    ...
    /** The maximum interior gap (currently 49.9999%). */
    public static final double MAX_INTERIOR_GAP = 0.4999999999999999999;
    ...
    public static final Paint DEFAULT_LABEL_SHADOW_PAINT = new Color(151, 151,
            151, 128);
    public static final Paint DEFAULT_OUTLINE_PAINT = new Color(0, 0,
            0, 0);
     ...
     * @since 1.0.7
     */
    protected boolean simpleLabels = true;
    ...
    private double maximumLabelWidth = 0.375;
    ...
    /** The link margin. */
    protected double labelLinkMargin = 0.025;
     ...
     */
    protected static final boolean DEBUG_DRAW_INTERIOR = false;
     ...
     */
    protected static final boolean DEBUG_DRAW_LINK_AREA = false;

    /**
     * This debug flag controls whether or not an outline is drawn showing
     * the pie area (in green).
     */
    protected static final boolean DEBUG_DRAW_PIE_AREA = false;
     ...
     */
    @SuppressWarnings("unchecked")
	public TPiePlot(PieDataset dataset) {
        super();
        ...
        this.setSectionOutlinesVisible(true);
    ...
    public boolean getSectionOutlinesVisible() {
        return this.isSectionOutlinesVisible();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TPiePlot)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        TPiePlot that = (TPiePlot) obj;
        ...
        if (this.isSectionOutlinesVisible() != that.isSectionOutlinesVisible()) {
            return false;
        }
        ...
        if (!ObjectUtilities.equal(this.getUrlGenerator(), that.getUrlGenerator())) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.getUrlGenerator() instanceof PublicCloneable) {
            clone.setUrlGenerator((PieURLGenerator) ObjectUtilities.clone(
