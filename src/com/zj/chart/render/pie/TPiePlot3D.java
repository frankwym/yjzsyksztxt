...
public class TPiePlot3D extends TPiePlot  implements Serializable {
     ...
     */
    public TPiePlot3D(PieDataset dataset) {
        super(dataset);
	...
	public void draw(Graphics2D g2, Rectangle2D plotArea, Point2D anchor,
        ...
        //modify by zf 三维饼图bug，simplelabel
...
//      Ellipse2D top = new Ellipse2D.Double(pieArea.getX(), pieArea.getY()+ depth,
//      pieArea.getWidth(), pieArea.getHeight() - depth);
//
//      Ellipse2D bottom = new Ellipse2D.Double(pieArea.getX(), pieArea.getY()
//      , pieArea.getWidth(), pieArea.getHeight() - depth);
//
//        Rectangle2D upper = new Rectangle2D.Double(top.getX(),
//                top.getCenterY(), pieArea.getWidth(), bottom.getMaxY()
//                - top.getCenterY());
//
//        Rectangle2D lower = new Rectangle2D.Double(pieArea.getX(), top.getY(),
//                pieArea.getWidth(), bottom.getCenterY() - top.getY());
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TPiePlot3D)) {
            return false;
        }
        TPiePlot3D that = (TPiePlot3D) obj;
