 ...
 */
public class TRingPlot extends TPiePlot {
    /**
	 * 
	 */
     ...
     */
    public TRingPlot(PieDataset dataset) {
        super(dataset);
        //hw-2013-3-2
        ...
        this.innerSeparatorExtension = 0.50;  // twenty percent
        this.outerSeparatorExtension = 0.50;  // twenty percent
        this.sectionDepth = 0.40; // 20%
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TRingPlot)) {
            return false;
        }
        TRingPlot that = (TRingPlot) obj;
