package com.zj.chart.render.line;
...
public class TLineAndShapeRenderer extends LineAndShapeRenderer{
     ...
     */
    public TLineAndShapeRenderer(boolean lines, boolean shapes) {
        super();
        ...
        if (pass == 0 && getItemLineVisible(row, column)) {
            if (column != 0) {
                ...
                if (previousValue != null) {
                    ...
                    Line2D line = null;
                    GeneralPath areaPolygon = new GeneralPath();
                    if (orientation == PlotOrientation.HORIZONTAL) {
                        line = new Line2D.Double(y0, x0, y1, x1);
                    }
                    else if (orientation == PlotOrientation.VERTICAL) {
                    	areaPolygon.moveTo(x0, y0);
                    	areaPolygon.lineTo(x0, dataArea.getMaxY());
                    	areaPolygon.lineTo(x1, dataArea.getMaxY());
                    	areaPolygon.lineTo(x1, y1);
                    ...
                    g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,this.getBaseAreaAlpha()));
                    g2.fill(areaPolygon);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TLineAndShapeRenderer)) {
            return false;
        }

        TLineAndShapeRenderer that = (TLineAndShapeRenderer) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        TLineAndShapeRenderer clone = (TLineAndShapeRenderer) super.clone();
	...
	public void setBaseAreaAlpha(float baseAreaAlpha) {
		this.baseAreaAlpha = baseAreaAlpha;
	}
